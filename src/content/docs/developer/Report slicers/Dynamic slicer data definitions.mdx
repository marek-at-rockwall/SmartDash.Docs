...
For a complete list of available properties if the slicer definition objects [go here](/reference/report-slicers/object-properties/).
...
To see how to use the `same_as` property please refer to the [Object properties](/reference/report-slicers/object-properties/) page in the Reference section.
