...
#### Basic - For single value slicers
...like date slicers and date range slicers which have two slicer fields where, however, each one only contains a single value.
```js {4}
{
    conditions: [
        { keepOriginal: true },
